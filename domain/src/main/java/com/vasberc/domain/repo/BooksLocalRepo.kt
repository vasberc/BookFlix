...
interface BooksLocalRepo {
    ...
    suspend fun insertAllBookRemoteKeys(books: List<BookItem>, prevPage: Int?, nextPage: Int?)

    suspend fun insertAllBooks(books: List<BookItem>, startingIndexOfPage: Int)
}